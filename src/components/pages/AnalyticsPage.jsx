...
const AnalyticsPage = ({ setCurrentPage }) => (
	<div className="px-4 py-8 sm:px-6 lg:px-8">
		<div className="max-w-7xl mx-auto">
			<h1 className="text-3xl font-bold mb-8 text-emerald-700 text-center">
				Tour Analytics
			</h1>
			<p className="text-lg text-gray-600 mb-10 text-center max-w-2xl mx-auto">
				Get insights into your interactive product tour creation. See how you use
				the builder and how your demo flows are structured.
			</p>
			...
			<div className="text-center mt-14">
				<p className="text-lg text-emerald-700 font-semibold mb-6">
					Ready to improve your product story? Try editing your tour or
					previewing new steps!
				</p>
				<button
